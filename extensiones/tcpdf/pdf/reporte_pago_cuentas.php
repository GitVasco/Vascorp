...
$cuentas=ControladorCuentas::ctrMostrarReportePagos($orden1,$orden2,$tip_doc,$vend,$inicio,$fin);
$total = ControladorCuentas::ctrMostrarReporteTotalPagos($orden1,$orden2,$tip_doc,$vend,$inicio,$fin);
