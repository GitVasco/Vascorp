...
if($opdocumento == 'todos'){
    ...
    $ventas=ControladorFacturacion::ctrMostrarVentaPostalRsm($optipo,$opdocumento,$impuesto,$vend,$inicio,$fin);

}else{

    $ventas = ControladorFacturacion::ctrMostrarTipoVentaPostalRsm($optipo,$opdocumento,$impuesto,$vend,$inicio,$fin);
...
<tbody>
    <tr>
        ...
        <td style="width:180px"><b>$value[ubicacion]</b></td>
    </tr>
</tbody>
</table>
EOF;
...
<tbody>
    <tr>
        ...
        <td style="width:443px;text-align:right">Total </td>
...
<tbody>
    <tr>
        ...
        <td style="width:58px"><b>$value[ubigeo]</b></td>
        <td style="width:350px"><b>$value[ubicacion]</b></td>
...
$pdf->Output('reporte_postalrsm_venta.pdf');
