...
if($opdocumento == 'todos'){
    ...
    $ventas=ControladorFacturacion::ctrMostrarVentaPostalDet($optipo,$opdocumento,$impuesto,$vend,$inicio,$fin);

}else{

    $ventas = ControladorFacturacion::ctrMostrarTipoVentaPostalDet($optipo,$opdocumento,$impuesto,$vend,$inicio,$fin);
...
<tbody>
    <tr>
        ...
        <td style="width:363px"><b>$value[ubicacion]</b></td>
...
<tbody>
    <tr>
        ...
        <td style="width:250px">$value[ubicacion]</td>
...
$pdf->Output('reporte_postaldet_venta.pdf');
