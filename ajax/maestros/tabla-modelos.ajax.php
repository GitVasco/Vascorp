...
class TablaModelos{
    ...
    public function mostrarTablaModelos(){
        ...
        //     $_GET["perfil"]=="Sistemas"){
                ...
                $botones =  "<div class='btn-group'><button class='btn btn-sm btn-primary btnVerModelo' modelo='".$modelos[$i]["modelo"]."' data-toggle='modal' data-target='#modalVerModelo'><i class='fa fa-eye'></i></button><button class='btn btn-sm btn-warning btnEditarModelo' modelo='".$modelos[$i]["modelo"]."' data-toggle='modal' data-target='#modalEditarModelo'><i class='fa fa-pencil'></i></button><button class='btn btn-sm btn-danger btnEliminarModelo' idModelo='".$modelos[$i]["id_modelo"]."' modelo='".$modelos[$i]["modelo"]."' imagen='".$modelos[$i]["imagen"]."'><i class='fa fa-times'></i></button><button class='btn btn-sm btn-default  btnReporteOM' title='Reporte Operaciones por modelo' codigo='".$modelos[$i]["modelo"]."' style='border:green 1px solid'><img src='vistas/img/plantilla/excel.png' width='17px'></button><button class='btn btn-sm btn-info btnGenerarArticulo' modelo='".$modelos[$i]["modelo"]."' title='Generar Articulo'><i class='fa fa-tag'></i></button><button class='btn btn-sm btnVerPrecio' modelo='".$modelos[$i]["modelo"]."'  descripcion = '".$modelos[$i]["nombre"]."' style='background:gray' data-toggle='modal' data-target='#modalVerPrecio'><i class='fa fa-money'></i></button></div>";
