...
class TablaUnidadMedidas{
    ...
    public function mostrarTablaUnidadMedidas(){
        ...
        $botones =  "<div class='btn-group'><button class='btn btn-warning btnEditarUnidadMedida' idUnidadMedida='".$unidadesmedida[$i]["id"]."' data-toggle='modal' data-target='#modalEditarUnidadMedida'><i class='fa fa-pencil'></i></button><button class='btn btn-danger btnEliminarUnidadMedida' idUnidadMedida='".$unidadesmedida[$i]["id"]."'><i class='fa fa-times'></i></button></div>"; 
