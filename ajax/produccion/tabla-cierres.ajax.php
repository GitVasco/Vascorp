...
class TablaCierres{
    ...
    public function mostrarTablaCierres(){
        ...
        $botones =  "<div class='btn-group'><button class='btn btn-sm btn-info btnVisualizarCierre' title='Visualizar Cierre' data-toggle='modal' data-target='#modalVisualizarCierre' codigoCierre='".$cierres[$i]["codigo"]."'><i class='fa fa-eye'></i></button><button class='btn btn-sm btn-warning btnEditarCierre' title='Editar Cierre' idCierre='".$cierres[$i]["codigo"]."' data-toggle='modal' data-target='#modalEditarCierre'><i class='fa fa-pencil'></i></button><button class='btn btn-sm btn-danger btnEliminarCierre' title='Eliminar Cierre' idCierre='".$cierres[$i]["codigo"]."'><i class='fa fa-times'></i></button><button class='btn btn-sm btn-outline-success pull-right btnDetalleCierre' idCierre='".$cierres[$i]["codigo"]."' style='border:green 1px solid'><img src='vistas/img/plantilla/excel.png' width='18px'></button></div>"; 
