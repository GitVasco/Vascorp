...
class TablaPrecioServicios{
    ...
    public function mostrarTablaPrecioServicios(){
        ...
        $botones =  "<div class='btn-group'><button class='btn btn-sm btn-warning btnEditarPrecioServicio' idPrecioServicio='".$precio[$i]["id"]."' data-toggle='modal' data-target='#modalEditarPrecioServicio'><i class='fa fa-pencil'></i></button><button class='btn btn-sm btn-danger btnEliminarPrecioServicio' idPrecioServicio='".$precio[$i]["id"]."'><i class='fa fa-times'></i></button></div>"; 
