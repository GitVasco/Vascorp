    ...
    */
    public function mostrarTablaAlmacenCorte(){
        ...
        $datosJson = '{
            ...
            */
            $botones =  "<div class='btn-group'><button class='btn btn-sm btn-info btnVisualizarAC' title='Visualizar Corte' data-toggle='modal' data-target='#modalVisualizarAC' codigoAC='".$almacencorte[$i]["codigo"]."'><i class='fa fa-eye'></i></button><button class='btn btn-sm btn-outline-success  btnReporteOC' title='Reporte Orden de Corte' codigo='".$almacencorte[$i]["codigo"]."'style='border:green 1px solid'><img src='vistas/img/plantilla/excel.png' width='17px'></button><button class='btn btn-sm btn-warning btnEditarAC' title='Editar Corte' data-toggle='modal' data-target='#modalEditarAC' codigoAC='".$almacencorte[$i]["codigo"]."'><i class='fa fa-pencil'></i></button></button><button class='btn btn-sm btn-success btnEditarNotificacion' title='Editar notificación' data-toggle='modal' data-target='#modalEditarNotificacion' codigoAC='".$almacencorte[$i]["codigo"]."'><i class='fa fa-commenting-o'></i></button></div>";
