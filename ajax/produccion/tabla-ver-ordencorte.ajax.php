...
class TablaVerOrdenCorte{

    /* 
    * MOSTRAR TABLA DE ORDENES DE CORTE
    */
    public function mostrarVerTablaOrdenCorte(){

        $ordencorte = ControladorOrdenCorte::ctrVisualizarOrdenCorteDetalle("ordencorte",$_GET["codigo"]);
...
=============================================*/ 
$activarVerOrdenCorte = new TablaVerOrdenCorte();
$activarVerOrdenCorte -> mostrarVerTablaOrdenCorte();