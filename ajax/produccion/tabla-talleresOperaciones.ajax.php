        ...
        $datosJson = '{
            ...
            */
            if($talleres[$i]["estado"] == "3"){
                ...
                $botones =  "<div class='btn-group'><button class='btn btn-warning btnEditarTallerOperacion' idTaller='".$talleres[$i]["codigo"]."' data-toggle='modal' data-target='#modalEditarCantidadOperacion'><i class='fa fa-edit'></i></button></div>";
