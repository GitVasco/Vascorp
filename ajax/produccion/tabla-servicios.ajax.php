...
class TablaServicios{
    ...
    public function mostrarTablaServicios(){
        ...
        $botones =  "<div class='btn-group'><button class='btn btn-sm btn-info btnVisualizarServicio' title='Visualizar Servicio' data-toggle='modal' data-target='#modalVisualizarServicio' codigoServicio='".$servicios[$i]["codigo"]."'><i class='fa fa-eye'></i></button><button class='btn btn-sm btn-warning btnEditarServicio' title='Editar Servicio' idServicio='".$servicios[$i]["codigo"]."' data-toggle='modal' data-target='#modalEditarServicio'><i class='fa fa-pencil'></i></button><button class='btn btn-sm btn-danger btnEliminarServicio' title='Eliminar Servicio' idServicio='".$servicios[$i]["codigo"]."'><i class='fa fa-times'></i></button><button class='btn btn-sm btn-outline-success pull-right btnDetalleServicio' idServicio='".$servicios[$i]["codigo"]."' style='border:green 1px solid'><img src='vistas/img/plantilla/excel.png' width='17px'></button></div>"; 
