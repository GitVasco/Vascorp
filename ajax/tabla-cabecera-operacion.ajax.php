...
class TablaOperaciones{
    ...
    public function mostrarTablaDetalleOperaciones(){
        ...
        $botones =  "<div class='btn-group'><button class='btn btn-warning btnEditarOperacion' idOperacion='".$operaciones[$i]["id"]."' href='editardetalle'><i class='fa fa-pencil'></i></button><button class='btn btn-danger btnEliminarOperacion' idOperacion='".$operaciones[$i]["id"]."'><i class='fa fa-times'></i></button></div>"; 
