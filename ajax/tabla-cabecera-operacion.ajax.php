...
class TablaOperaciones{
    ...
    public function mostrarTablaDetalleOperaciones(){
        ...
        $botones =  "<div class='btn-group'><button class='btn btn-primary btnDetalleOperacion' idOperacion='".$operaciones[$i]["id"]."'data-toggle='modal' data-target='#modalDetalleOperacion' ><i class='fa fa-eye'></i></button><button class='btn btn-warning btnEditarOperacion' idOperacion='".$operaciones[$i]["id"]."' ><i class='fa fa-pencil'></i></button><button class='btn btn-danger btnEliminarOperacion' idOperacion='".$operaciones[$i]["id"]."'><i class='fa fa-times'></i></button></div>"; 
