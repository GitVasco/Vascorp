        ...
        $datosJson = '{
            ...
            */
            ...
            //     $_GET["perfil"]=="Udp"){
                ...
                $botones =  "<div class='btn-group'><button class='btn btn-info btn-sm btnVisualizarTarjeta' title='Visualizar Tarjeta' data-toggle='modal' data-target='#modalVisualizarTarjeta' articuloTarjeta='".$tarjetas[$i]["articulo"]."'><i class='fa fa-eye'></i></button><button class='btn btn-sm btn-primary  btnCopiarTarjeta' title='Copiar Tarjeta' idTarjeta='".$tarjetas[$i]["id"]."'><i class='fa fa-files-o'></i></button><button class='btn btn-sm btn-warning  btnEditarTarjeta' title='Editar Tarjeta' idTarjeta='".$tarjetas[$i]["id"]."'><i class='fa fa-pencil'></i></button><button class='btn btn-sm btn-success  btnAgregarFicha' title='Ficha tecnica' data-toggle='modal' data-target='#modalAgregarFichaTecnica'idTarjeta='".$tarjetas[$i]["id"]."'><i class='fa fa-file-pdf-o'></i></button><button class='btn btn-sm btn-danger  btnEliminarTarjeta' title='Eliminar Tarjeta' idTarjeta='".$tarjetas[$i]["id"]."'><i class='fa fa-times'></i></button></div>";
