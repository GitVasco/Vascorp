...
class TablaTipoMovimientos{
    ...
    public function mostrarTablaTipoMovimientos(){
        ...
        $botones =  "<div class='btn-group'><button class='btn btn-warning btnEditarTipoMovimiento' idTipoMovimiento='".$tipomovimiento[$i]["id"]."' data-toggle='modal' data-target='#modalEditarTipoMovimiento'><i class='fa fa-pencil'></i></button><button class='btn btn-danger btnEliminarTipoMovimiento' idTipoMovimiento='".$tipomovimiento[$i]["id"]."'><i class='fa fa-times'></i></button></div>"; 
