...
class TablaMateriaPrima{
    ...
    public function mostrarTablaMateriaPrima(){
        ...
        $botones =  "<div class='btn-group'><button class='btn btn-info btn-xs agregarMateriaNota recuperarBoton' idMateriaNota='".$materiaprima[$i]["CodPro"]."'><i class='fa fa-plus-square'></i> Agregar</button></div>"; 
