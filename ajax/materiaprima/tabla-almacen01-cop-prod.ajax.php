...
class TablaMateriaPrima{
    ...
    public function mostrarTablaMateriaPrima(){
        ...
        $datosJson = '{
            ...
            =============================================*/
                $botones = "<div class='btn-group'><button class='btn btn-primary btn-xs  agregarCopas recuperarBoton' codpro='".$materiaprima[$i]["codpro"]."' idBoton='".$materiaprima[$i]["codpro"]."' title='Agregar Copas'><i class='fa fa-plus-square'></i></button></div>";
