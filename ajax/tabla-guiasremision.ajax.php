...
class TablaGuiasRemision{
    ...
    public function mostrarTablaGuiasRemision(){
        ...
        if($gremision[$i]["doc_destino"] != ""){
            ...
            $botones =  "<div class='btn-group'><button title='Facturar Pedido' class='btn btn-primary btnFacturarA' documento='".$gremision[$i]["documento"]."' data-toggle='modal' data-target='#A'><i class='fa fa-paper-plane'></i></button></div>";
