    ...
    public function mostrarTablaNotasCD(){
        ...
        $datosJson = '{
            ...
            */
                ...
                $botones =  "<div class='btn-group'><button class='btn btn-warning btnEditarNotaCD' title='Editar notas CD' tipo='".$notas[$i]["tipo"]."' documento='".$notas[$i]["documento"]."'><i class='fa fa-pencil'></i></button></button></div>";
