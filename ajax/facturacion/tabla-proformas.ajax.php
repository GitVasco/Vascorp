...
class TablaProformas{
    ...
    public function mostrarTablaProformas(){
        ...
        if($proformas[$i]["doc_destino"] != ""){
            $botones =  "<div class='btn-group'><button title='Facturar Pedido' class='btn btn-sm btn-primary btnFacturarA' documento='".$proformas[$i]["documento"]."' cod_cli='".$proformas[$i]["cliente"]."'  nom_cli='".$proformas[$i]["nombre"]."' tip_doc='".$proformas[$i]["tip_doc"]."' nro_doc='".$proformas[$i]["num_doc"]."' cod_ven='".$proformas[$i]["vendedor"]."' serie_dest='".$proformas[$i]["serie_dest"]."' nro_dest='".$proformas[$i]["nro_dest"]."' data-toggle='modal' data-target='#modalFacturarA'><i class='fa fa-paper-plane'></i></button><button title='Imprimir Proforma' class='btn btn-sm btn-success btnImprimirProforma' tipo='".$proformas[$i]["tipo"]."' documento='".$proformas[$i]["documento"]."'><i class='fa fa-print'></i></button></div>";
        }else{

            $botones =  "<div class='btn-group'><button title='Facturar Pedido' class='btn btn-sm btn-primary btnFacturarB' documento='".$proformas[$i]["documento"]."' cod_cli='".$proformas[$i]["cliente"]."'  nom_cli='".$proformas[$i]["nombre"]."' tip_doc='".$proformas[$i]["tip_doc"]."' nro_doc='".$proformas[$i]["num_doc"]."' cod_ven='".$proformas[$i]["vendedor"]."' data-toggle='modal' data-target='#modalFacturarB'><i class='fa fa-paper-plane'></i></button><button title='Imprimir Proforma' class='btn btn-sm btn-success btnImprimirProforma' tipo='".$proformas[$i]["tipo"]."' documento='".$proformas[$i]["documento"]."'><i class='fa fa-print'></i></button></div>";
