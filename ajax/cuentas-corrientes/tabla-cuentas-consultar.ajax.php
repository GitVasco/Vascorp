...
class TablaCuentasConsultar{
    ...
    public function mostrarTablaCuentasConsultar(){
        ...
        =============================================*/      
            ...
            $botones =  "<div class='btn-group'><button class='btn btn-xs btn-primary btnVisualizarCuentaConsultar' codCta='".$cuenta[$i]["tipo_doc"]."' numCta='".$cuenta[$i]["num_cta"]."'  title='Visualizar cuenta'><i class='fa fa-eye'></i></button></div>";
