...
<body onload="window.print();">
  ...
  <!-- codigo imprimir -->
    ...
    <thead>
      ...
      <tr style="height:200px">
        <td style="width:100%;text-align:justify;line-height:35px">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp El portador del presente es un trabajador de nuestra Empresa <?php echo "<b>". $respuesta["nombres"]." ".$respuesta["ape_pat"]." ".$respuesta["ape_mat"]."</b>"; ?>, quien esta facultado por las leyes del Estado de Emergencia como personal minimo e indispensable que nuestra Empresa ha determinado que necesita para mantener las operaciones indispensables de nuestra actividad empresarial.</td>
      </tr>
