...
# Titulo de la hoja
$objPHPExcel->getActiveSheet()->setTitle('INGRESOS DE STOCK ');
...
// TITULO
$fila = 2;
$objPHPExcel->getActiveSheet()->SetCellValue("D$fila", 'INGRESOS DE STOCK ');
...
# Nombre del archivo
header('Content-Disposition: attachment; filename=" INGRESOS DE STOCK - '.$fecha.'.xls"');
