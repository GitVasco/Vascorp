...
$objPHPExcel->getActiveSheet()->setTitle("DOCUMENTOS POR COBRAR ".$fechaactual["year"]);
...
$fila = 2;
$objPHPExcel->getActiveSheet()->SetCellValue("F$fila", 'DOCUMENTOS POR COBRAR DEL '.$fechaactual["year"]);
...
$objPHPExcel->getActiveSheet()->SetCellValue("G$fila", 'NRO. DOC.');
...
$objPHPExcel->getActiveSheet()->SetCellValue("E$fila", 'VENCIMIENTO.');
$objPHPExcel->getActiveSheet()->setSharedStyle($borde2, "E$fila");
$objPHPExcel->getActiveSheet()->getStyle("E$fila")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);

$objPHPExcel->getActiveSheet()->SetCellValue("F$fila", 'VEND.');
$objPHPExcel->getActiveSheet()->setSharedStyle($borde2, "F$fila");
$objPHPExcel->getActiveSheet()->getStyle("F$fila")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);

$objPHPExcel->getActiveSheet()->SetCellValue("G$fila", 'ORIGINAL');
...
$objPHPExcel->getActiveSheet()->SetCellValue("I$fila", 'BANCO');
$objPHPExcel->getActiveSheet()->setSharedStyle($borde2, "I$fila");
$objPHPExcel->getActiveSheet()->getStyle("I$fila")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);

$objPHPExcel->getActiveSheet()->SetCellValue("J$fila", 'NRO. UNICO');
$objPHPExcel->getActiveSheet()->setSharedStyle($borde2, "J$fila");
$objPHPExcel->getActiveSheet()->getStyle("J$fila")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);

$objPHPExcel->getActiveSheet()->SetCellValue("K$fila", 'TOTAL S/');
$objPHPExcel->getActiveSheet()->setSharedStyle($borde2, "K$fila");
$objPHPExcel->getActiveSheet()->getStyle("K$fila")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);

$objPHPExcel->getActiveSheet()->SetCellValue("L$fila", 'PROT.');
...
$clientes= ControladorCuentas::ctrMostrarClientesSaldo($cli,$vend);


foreach ($clientes as $key1 => $value1) {

  $objPHPExcel->getActiveSheet()->setCellValueExplicit("D$fila", "Cliente :".utf8_encode($value1["cliente"]." - ".$value1["nombre"]), PHPExcel_Cell_DataType::TYPE_STRING);
...
foreach ($cuentas as $key => $value) {
  ...
  $objPHPExcel->getActiveSheet()->setCellValueExplicit("B$fila", utf8_encode($value["tipo_doc"]), PHPExcel_Cell_DataType::TYPE_STRING);
  $objPHPExcel->getActiveSheet()->setCellValueExplicit("C$fila", utf8_encode($value["num_cta"]), PHPExcel_Cell_DataType::TYPE_STRING);
  $objPHPExcel->getActiveSheet()->SetCellValue("F$fila", $value["fecha"]);
  $objPHPExcel->getActiveSheet()->SetCellValue("G$fila", $value["fecha_ven"]);
  $objPHPExcel->getActiveSheet()->setCellValueExplicit("E$fila", utf8_encode($value["vendedor"]), PHPExcel_Cell_DataType::TYPE_STRING);
  $objPHPExcel->getActiveSheet()->setCellValueExplicit("H$fila", utf8_encode($value["doc_origen"]), PHPExcel_Cell_DataType::TYPE_STRING);
  $objPHPExcel->getActiveSheet()->setCellValueExplicit("I$fila", utf8_encode($value["estado"]), PHPExcel_Cell_DataType::TYPE_STRING);
  $objPHPExcel->getActiveSheet()->setCellValueExplicit("I$fila", utf8_encode($value["banco"]), PHPExcel_Cell_DataType::TYPE_STRING);
  $objPHPExcel->getActiveSheet()->setCellValueExplicit("K$fila", utf8_encode($value["num_unico"]), PHPExcel_Cell_DataType::TYPE_STRING);
  $objPHPExcel->getActiveSheet()->setCellValueExplicit("K$fila", utf8_encode($value["saldo"]), PHPExcel_Cell_DataType::TYPE_STRING);
  $objPHPExcel->getActiveSheet()->setCellValueExplicit("L$fila", utf8_encode($value["protesta"]), PHPExcel_Cell_DataType::TYPE_STRING);
...
# Nombre del archivo
header('Content-Disposition: attachment; filename=" DOCUMENTOS POR COBRAR '.$fecha.'.xls"');
