...
$objPHPExcel->getProperties()->setTitle("E - Reporte de OC Parciales"); //titulo
...
$objPHPExcel->getActiveSheet()->setTitle("Reporte de OC Parciales"); //establecer titulo de hoja
...
$fila=6;
$objPHPExcel->getActiveSheet()->SetCellValue("B$fila", "RESUMEN - LISTADO OC PARCIALES");
...
foreach($ordencompra as $res){    
  ...
  $objPHPExcel->getActiveSheet()->getStyle("F$fila")->getNumberFormat()->setFormatCode('000'); 
...
// nombre del archivo
header('Content-Disposition: attachment; filename="Reporte_OCParciales.xls"');
//**********************************************************************
