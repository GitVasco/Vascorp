...
// TITULO
$fila = 2;
$objPHPExcel->getActiveSheet()->SetCellValue("G$fila", 'PARAS');
...
$objPHPExcel->getActiveSheet()->SetCellValue("B$fila", 'PARAS');
...
$sqlDetalle = mysql_query("SELECT * FROM parajf") or die(mysql_error());
...
# Nombre del archivo
header('Content-Disposition: attachment; filename=" PARAS - '.$fecha.'.xls"');
