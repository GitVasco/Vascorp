...
$objPHPExcel->getActiveSheet()->setTitle("REPORTE DE SUBLIMADOS ");
...
$objPHPExcel->getActiveSheet()->SetCellValue("F$fila", 'SUBLIMADOS');
...
$objPHPExcel->getActiveSheet()->SetCellValue("H$fila", 'fecha de fin:');
$objPHPExcel->getActiveSheet()->setSharedStyle($texto1, "H$fila");

$objPHPExcel->getActiveSheet()->SetCellValue("I$fila", $fin);
$objPHPExcel->getActiveSheet()->mergeCells("I$fila:J$fila");
$objPHPExcel->getActiveSheet()->setSharedStyle($texto2, "I$fila:J$fila");
/* 
todo: FIN CABECERA
*/
...
$objPHPExcel->getActiveSheet()->SetCellValue("G$fila", 'MATERIA');
...
$objPHPExcel->getActiveSheet()->SetCellValue("K$fila", 'TIEMPO');
...
$objPHPExcel->getActiveSheet()->SetCellValue("F$fila", 'MATERIA');
$objPHPExcel->getActiveSheet()->setSharedStyle($borde2, "F$fila");
$objPHPExcel->getActiveSheet()->getStyle("F$fila")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);

$objPHPExcel->getActiveSheet()->SetCellValue("G$fila", 'PRIMA');
$objPHPExcel->getActiveSheet()->setSharedStyle($borde2, "G$fila");
$objPHPExcel->getActiveSheet()->getStyle("G$fila")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);

$objPHPExcel->getActiveSheet()->SetCellValue("H$fila", 'MATERIA');
$objPHPExcel->getActiveSheet()->setSharedStyle($borde2, "H$fila");
$objPHPExcel->getActiveSheet()->getStyle("H$fila")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);

$objPHPExcel->getActiveSheet()->SetCellValue("I$fila", 'INICIO');
...
$objPHPExcel->getActiveSheet()->SetCellValue("K$fila", 'UTILIZADO');
$objPHPExcel->getActiveSheet()->setSharedStyle($borde2, "K$fila");
$objPHPExcel->getActiveSheet()->getStyle("K$fila")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);

$objPHPExcel->getActiveSheet()->SetCellValue("L$fila", 'CORTE');
...
$objPHPExcel->getActiveSheet()->SetCellValue("F$fila", 'PRIMA');
...
$objPHPExcel->getActiveSheet()->SetCellValue("H$fila", 'PRIMA');
...
$sqlCabecera = ControladorProcedimientos::ctrRangoFechasSublimados($inicio,$fin);
...
for($i = 0; $i < count($sqlCabecera); $i++){
  ...
  $objPHPExcel->getActiveSheet()->setCellValueExplicit("C$fila", utf8_encode($sqlCabecera[$i]["nombre"]), PHPExcel_Cell_DataType::TYPE_STRING);
  $objPHPExcel->getActiveSheet()->setCellValueExplicit("D$fila", utf8_encode($sqlCabecera[$i]["nom_color"]), PHPExcel_Cell_DataType::TYPE_STRING);
  $objPHPExcel->getActiveSheet()->setCellValueExplicit("E$fila", utf8_encode($sqlCabecera[$i]["cantidad"]), PHPExcel_Cell_DataType::TYPE_STRING);
  $objPHPExcel->getActiveSheet()->setCellValueExplicit("F$fila", utf8_encode($sqlCabecera[$i]["materia_prima"]), PHPExcel_Cell_DataType::TYPE_STRING);
  $objPHPExcel->getActiveSheet()->setCellValueExplicit("G$fila", utf8_encode($sqlCabecera[$i]["descripcion"]), PHPExcel_Cell_DataType::TYPE_STRING);
  $objPHPExcel->getActiveSheet()->setCellValueExplicit("H$fila", utf8_encode($sqlCabecera[$i]["color"]), PHPExcel_Cell_DataType::TYPE_STRING);
  $objPHPExcel->getActiveSheet()->setCellValueExplicit("I$fila", utf8_encode($sqlCabecera[$i]["fecha_inicio"]), PHPExcel_Cell_DataType::TYPE_STRING);
  $objPHPExcel->getActiveSheet()->setCellValueExplicit("J$fila", utf8_encode($sqlCabecera[$i]["fecha_fin"]), PHPExcel_Cell_DataType::TYPE_STRING);
  $objPHPExcel->getActiveSheet()->setCellValueExplicit("K$fila", utf8_encode($sqlCabecera[$i]["tiempo_utilizado"]), PHPExcel_Cell_DataType::TYPE_STRING);
  $objPHPExcel->getActiveSheet()->setCellValueExplicit("L$fila", utf8_encode($sqlCabecera[$i]["cod_corte"]), PHPExcel_Cell_DataType::TYPE_STRING);
  $objPHPExcel->getActiveSheet()->setCellValueExplicit("M$fila", utf8_encode($sqlCabecera[$i]["nom_user"]), PHPExcel_Cell_DataType::TYPE_STRING);
...
$objPHPExcel->getActiveSheet()->getColumnDimension('G')->setWidth(40.29);
...
header('Content-Disposition: attachment; filename=" SUBLIMADOS.xls"');
