...
# Titulo de la hoja
$objPHPExcel->getActiveSheet()->setTitle("TRABAJADORES -".$fecha);
...
// TITULO
$fila = 2;
$objPHPExcel->getActiveSheet()->SetCellValue("G$fila", 'TRABAJADORES');
...
$objPHPExcel->getActiveSheet()->SetCellValue("B$fila", 'COD. TRABAJADOR');
...
$objPHPExcel->getActiveSheet()->SetCellValue("C$fila", 'TIPO DOCUMENTO');
$objPHPExcel->getActiveSheet()->setSharedStyle($borde2, "C$fila");
$objPHPExcel->getActiveSheet()->getStyle("C$fila")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);

$objPHPExcel->getActiveSheet()->SetCellValue("D$fila", 'N° DOCUMENTO');
...
$objPHPExcel->getActiveSheet()->SetCellValue("E$fila", 'NOMBRES Y APELLIDOS');
$objPHPExcel->getActiveSheet()->setSharedStyle($borde2, "E$fila");
$objPHPExcel->getActiveSheet()->getStyle("E$fila")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);

$objPHPExcel->getActiveSheet()->SetCellValue("F$fila", 'TIPO TRABAJADOR');
...
$objPHPExcel->getActiveSheet()->SetCellValue("H$fila", 'SUELDO X MES');
...
AND tt.cod_tip_tra = t.cod_tip_tra ") or die(mysql_error());
...
while($respDetalle = mysql_fetch_array($sqlDetalle)){
    ...
    $objPHPExcel->getActiveSheet()->SetCellValue("C$fila", utf8_encode($respDetalle["tipo_doc"]));
    
    $objPHPExcel->getActiveSheet()->SetCellValue("D$fila", utf8_encode($respDetalle["nro_doc_tra"]));
    
    $objPHPExcel->getActiveSheet()->SetCellValue("E$fila", utf8_encode($respDetalle["nombre"]));

    $objPHPExcel->getActiveSheet()->SetCellValue("F$fila", utf8_encode($respDetalle["nom_tip_trabajador"]));

    $objPHPExcel->getActiveSheet()->SetCellValue("G$fila", utf8_encode($respDetalle["estado"]));

    $objPHPExcel->getActiveSheet()->SetCellValue("H$fila", utf8_encode($respDetalle["sueldo_total"]));
...
$objPHPExcel->getActiveSheet()->getColumnDimension('B')->setWidth(20.72);
...
$objPHPExcel->getActiveSheet()->getColumnDimension('E')->setWidth(35.72);
$objPHPExcel->getActiveSheet()->getColumnDimension('F')->setWidth(20.72);
$objPHPExcel->getActiveSheet()->getColumnDimension('G')->setWidth(10.87);
$objPHPExcel->getActiveSheet()->getColumnDimension('H')->setWidth(15.57);
/* 
* CREAR EL ARCHIVO
*/
