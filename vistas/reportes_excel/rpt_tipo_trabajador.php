...
# Titulo de la hoja
$objPHPExcel->getActiveSheet()->setTitle("TIPO DE TRABAJADORES -".$fecha);
...
// TITULO
$fila = 2;
$objPHPExcel->getActiveSheet()->SetCellValue("G$fila", 'TIPO DE TRABAJADORES');
...
$objPHPExcel->getActiveSheet()->SetCellValue("B$fila", 'COD. TIPO TRABAJADOR');
...
$objPHPExcel->getActiveSheet()->SetCellValue("C$fila", 'TIPO DE TRABAJADOR');
...
$sqlDetalle = mysql_query("SELECT * FROM tipo_trabajadorjf") or die(mysql_error());
...
while($respDetalle = mysql_fetch_array($sqlDetalle)){
    ...
    $objPHPExcel->getActiveSheet()->SetCellValue("B$fila", utf8_encode($respDetalle["cod_tip_tra"])); 
    
    $objPHPExcel->getActiveSheet()->SetCellValue("C$fila", utf8_encode($respDetalle["nom_tip_trabajador"]));

    $objPHPExcel->getActiveSheet()->SetCellValue("D$fila", utf8_encode($respDetalle["detalle"]));
...
$objPHPExcel->getActiveSheet()->getColumnDimension('B')->setWidth(22.72);
$objPHPExcel->getActiveSheet()->getColumnDimension('C')->setWidth(25.72);
$objPHPExcel->getActiveSheet()->getColumnDimension('D')->setWidth(20.72);
/* 
* CREAR EL ARCHIVO
*/
...
# Nombre del archivo
header('Content-Disposition: attachment; filename=" TIPO DE TRABAJADORES - '.$fecha.'.xls"');
