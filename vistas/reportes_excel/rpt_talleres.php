...
# Titulo de la hoja
$objPHPExcel->getActiveSheet()->setTitle("TALLERES GENERALES -".$fecha);
...
// TITULO
$fila = 2;
$objPHPExcel->getActiveSheet()->SetCellValue("G$fila", 'TALLER GENERAL');
...
$sqlDetalle = mysql_query("SELECT et.id,
et.sector,
...
ON et.sector = s.cod_sector ORDER BY et.id ASC") or die(mysql_error());
...
# Nombre del archivo
header('Content-Disposition: attachment; filename=" TALLERES GENERALES - '.$fecha.'.xls"');
