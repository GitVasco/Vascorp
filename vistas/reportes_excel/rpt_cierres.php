...
# Titulo de la hoja
$objPHPExcel->getActiveSheet()->setTitle("CIERRES -".$fecha);
...
// TITULO
$fila = 2;
$objPHPExcel->getActiveSheet()->SetCellValue("D$fila", 'CIERRES');
...
$modelo = "null";
$sqlCabecera = ModeloCierres::mdlVisualizarCierreDetalle(null);
...
# Nombre del archivo
header('Content-Disposition: attachment; filename=" CIERRES - '.$fecha.'.xls"');
