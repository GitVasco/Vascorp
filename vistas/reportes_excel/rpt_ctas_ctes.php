...
$objPHPExcel->getActiveSheet()->SetCellValue("K$fila", 'Cod Cli');
$objPHPExcel->getActiveSheet()->SetCellValue("L$fila", 'Cliente');
$objPHPExcel->getActiveSheet()->SetCellValue("M$fila", 'Vend');
$objPHPExcel->getActiveSheet()->SetCellValue("N$fila", 'Notas');
$objPHPExcel->getActiveSheet()->SetCellValue("O$fila", 'Fec Acep');
$objPHPExcel->getActiveSheet()->SetCellValue("P$fila", 'Banco');
$objPHPExcel->getActiveSheet()->SetCellValue("Q$fila", 'Num Unico');
$objPHPExcel->getActiveSheet()->SetCellValue("R$fila", 'Renovacion');
$objPHPExcel->getActiveSheet()->SetCellValue("S$fila", 'Protesta');
$objPHPExcel->getActiveSheet()->SetCellValue("T$fila", 'Estado Doc');
$objPHPExcel->getActiveSheet()->SetCellValue("U$fila", 'Fec Envio');
...
while ($respDetalle = mysql_fetch_array($sqlDetalle)) {
    ...
    $objPHPExcel->getActiveSheet()->SetCellValue("K$fila", utf8_encode($respDetalle["cliente"]));
    $objPHPExcel->getActiveSheet()->SetCellValue("L$fila", utf8_encode($respDetalle["nombre"]));
    $objPHPExcel->getActiveSheet()->SetCellValue("M$fila", utf8_encode($respDetalle["vendedor"]));
    $objPHPExcel->getActiveSheet()->SetCellValue("N$fila", utf8_encode($respDetalle["notas"]));
    $objPHPExcel->getActiveSheet()->SetCellValue("O$fila", date("d/m/Y", strtotime($respDetalle['fecha_cep'])));
    $objPHPExcel->getActiveSheet()->SetCellValue("P$fila", utf8_encode($respDetalle["banco"]));
    $objPHPExcel->getActiveSheet()->SetCellValue("Q$fila", utf8_encode($respDetalle["num_unico"]));
    $objPHPExcel->getActiveSheet()->SetCellValue("R$fila", utf8_encode($respDetalle["renovacion"]));
    $objPHPExcel->getActiveSheet()->SetCellValue("S$fila", utf8_encode($respDetalle["protesta"]));
    $objPHPExcel->getActiveSheet()->SetCellValue("T$fila", utf8_encode($respDetalle["estado_doc"]));
    $objPHPExcel->getActiveSheet()->SetCellValue("U$fila", date("d/m/Y", strtotime($respDetalle['fecha_envio'])));
}
