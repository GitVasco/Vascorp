...
# Titulo de la hoja
$objPHPExcel->getActiveSheet()->setTitle("Maquinas -".$fecha);
...
// TITULO
$fila = 2;
$objPHPExcel->getActiveSheet()->SetCellValue("D$fila", 'Maquinas');
...
$fila = 7;
$objPHPExcel->getActiveSheet()->SetCellValue("A$fila", 'Cod. Tip');
$objPHPExcel->getActiveSheet()->setSharedStyle($borde2, "A$fila");
$objPHPExcel->getActiveSheet()->getStyle("A$fila")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);

$objPHPExcel->getActiveSheet()->SetCellValue("B$fila", 'Nom. Tipo');
...
$objPHPExcel->getActiveSheet()->SetCellValue("D$fila", 'Ubicación');
$objPHPExcel->getActiveSheet()->setSharedStyle($borde2, "D$fila");
$objPHPExcel->getActiveSheet()->getStyle("D$fila")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);

$objPHPExcel->getActiveSheet()->SetCellValue("E$fila", 'Marca Equipo');
$objPHPExcel->getActiveSheet()->setSharedStyle($borde2, "E$fila");
$objPHPExcel->getActiveSheet()->getStyle("E$fila")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);

$objPHPExcel->getActiveSheet()->SetCellValue("F$fila", 'Modelo Equipo');
...
$objPHPExcel->getActiveSheet()->SetCellValue("G$fila", 'Serie Equipo');
$objPHPExcel->getActiveSheet()->setSharedStyle($borde2, "G$fila");
$objPHPExcel->getActiveSheet()->getStyle("G$fila")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);

$objPHPExcel->getActiveSheet()->SetCellValue("H$fila", 'Ult. Mantenimiento');
...
$sqlDetalle = mysql_query("SELECT 
                            ...
                            FROM
                            equipos_jf e 
                            ORDER BY e.cod_tipo") or die(mysql_error());
...
while($respDetalle = mysql_fetch_array($sqlDetalle)){
    ...
    $objPHPExcel->getActiveSheet()->SetCellValue("A$fila", utf8_encode($respDetalle["cod_tipo"]));
    
    $objPHPExcel->getActiveSheet()->SetCellValue("B$fila", utf8_encode($respDetalle["nombre_tipo_maquina"])); 
    
    $objPHPExcel->getActiveSheet()->SetCellValue("C$fila", utf8_encode($respDetalle["descripcion"]));
    
    $objPHPExcel->getActiveSheet()->SetCellValue("D$fila", utf8_encode($respDetalle["ubicacion_maquina"]));
    
    $objPHPExcel->getActiveSheet()->SetCellValue("E$fila", utf8_encode($respDetalle["marca_equipo"]));

    $objPHPExcel->getActiveSheet()->SetCellValue("F$fila", utf8_encode($respDetalle["modelo_equipo"]));

    $objPHPExcel->getActiveSheet()->SetCellValue("G$fila", utf8_encode($respDetalle["serie_equipo"]));

    $objPHPExcel->getActiveSheet()->SetCellValue("H$fila", utf8_encode($respDetalle["fec_ult_mant"]));
...
$objPHPExcel->getActiveSheet()->getColumnDimension('A')->setWidth(8.14);
$objPHPExcel->getActiveSheet()->getColumnDimension('B')->setWidth(12.28);
$objPHPExcel->getActiveSheet()->getColumnDimension('C')->setWidth(37.56);
$objPHPExcel->getActiveSheet()->getColumnDimension('D')->setWidth(11.43);
$objPHPExcel->getActiveSheet()->getColumnDimension('E')->setWidth(13);
$objPHPExcel->getActiveSheet()->getColumnDimension('F')->setWidth(31.42);
$objPHPExcel->getActiveSheet()->getColumnDimension('G')->setWidth(13);
$objPHPExcel->getActiveSheet()->getColumnDimension('H')->setWidth(18.85);
$objPHPExcel->getActiveSheet()->getColumnDimension('I')->setWidth(10.14);
/* 
* CREAR EL ARCHIVO
*/
