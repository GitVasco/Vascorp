...
# Titulo de la hoja
$objPHPExcel->getActiveSheet()->setTitle("OPERACIONES -".$fecha);
...
// TITULO
$fila = 2;
$objPHPExcel->getActiveSheet()->SetCellValue("G$fila", 'OPERACIONES');
...
$objPHPExcel->getActiveSheet()->SetCellValue("B$fila", 'COD. OPERACION');
...
$sqlDetalle = mysql_query("SELECT * FROM operacionesjf") or die(mysql_error());
...
# Nombre del archivo
header('Content-Disposition: attachment; filename=" OPERACIONES - '.$fecha.'.xls"');
