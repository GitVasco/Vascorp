...
# Titulo de la hoja
$objPHPExcel->getActiveSheet()->setTitle("Incobrables");
...
// TITULO
$fila = 2;
$objPHPExcel->getActiveSheet()->SetCellValue("D$fila", 'CUENTAS INCOBRABLES POR AÑO');
...
$fila = 4;
$objPHPExcel->getActiveSheet()->SetCellValue("A$fila", 'AÑO');
/* $objPHPExcel->getActiveSheet()->setSharedStyle($borde2, "A$fila");
$objPHPExcel->getActiveSheet()->getStyle("A$fila")->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER); */

$objPHPExcel->getActiveSheet()->SetCellValue("B$fila", 'SALDO');
...
$sqlDetalle = mysql_query("SELECT 
          ...
          GROUP BY YEAR(cc.fecha_ven)") or die(mysql_error());


while($respDetalle = mysql_fetch_array($sqlDetalle)){

    $fila+=1;
    $objPHPExcel->getActiveSheet()->SetCellValue("A$fila", utf8_encode($respDetalle["anno"])); 
    $objPHPExcel->getActiveSheet()->SetCellValue("B$fila", utf8_encode($respDetalle["saldo"])); 
