...
$objPHPExcel->getActiveSheet()->SetCellValue("M$fila", 'CAN.PEDIDA');
$objPHPExcel->getActiveSheet()->SetCellValue("N$fila", 'DESPACHO');
$objPHPExcel->getActiveSheet()->SetCellValue("O$fila", 'SALDO');
$objPHPExcel->getActiveSheet()->SetCellValue("P$fila", 'ESTADO');
$objPHPExcel->getActiveSheet()->setSharedStyle($subtitulo, "B$fila:P$fila"); //establecer estilo
$objPHPExcel->getActiveSheet()->getStyle("B$fila:P$fila")->getFont()->setBold(true); //negrita
...
foreach ($ordenesServicios as $res) {
  ...
  $objPHPExcel->getActiveSheet()->SetCellValue("M$fila", utf8_encode($res["CantidadIni"]));
  $objPHPExcel->getActiveSheet()->SetCellValue("N$fila", utf8_encode($res["Despacho"]));
  $objPHPExcel->getActiveSheet()->SetCellValue("O$fila", utf8_encode($res["Saldo"]));
