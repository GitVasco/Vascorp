...
# Titulo de la hoja
$objPHPExcel->getActiveSheet()->setTitle("COLORES -" . $fecha);
...
// TITULO
$fila = 2;
$objPHPExcel->getActiveSheet()->SetCellValue("D$fila", 'Tipo de Pagos');
...
$sqlDetalle = mysql_query("SELECT * FROM tipo_pagosjf") or die(mysql_error());
...
# Nombre del archivo
header('Content-Disposition: attachment; filename=" COLORES - ' . $fecha . '.xls"');
