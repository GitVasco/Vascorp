...
# Titulo de la hoja
$objPHPExcel->getActiveSheet()->setTitle('INGRESOS DE STOCK '.$documento);
...
// TITULO
$fila = 2;
$objPHPExcel->getActiveSheet()->SetCellValue("D$fila", 'INGRESOS DE STOCK '.$documento);
...
while($respDetalle = mysql_fetch_array($sqlDetalle)){
    ...
    $objPHPExcel->getActiveSheet()->SetCellValue("E$fila", utf8_encode($respDetalle["t1"]));

    $objPHPExcel->getActiveSheet()->SetCellValue("F$fila", utf8_encode($respDetalle["t2"]));

    $objPHPExcel->getActiveSheet()->SetCellValue("G$fila", utf8_encode($respDetalle["t3"]));
    
    $objPHPExcel->getActiveSheet()->SetCellValue("H$fila", utf8_encode($respDetalle["t4"]));

    $objPHPExcel->getActiveSheet()->SetCellValue("I$fila", utf8_encode($respDetalle["t5"]));

    $objPHPExcel->getActiveSheet()->SetCellValue("J$fila", utf8_encode($respDetalle["t6"]));

    $objPHPExcel->getActiveSheet()->SetCellValue("K$fila", utf8_encode($respDetalle["t7"]));

    $objPHPExcel->getActiveSheet()->SetCellValue("L$fila", utf8_encode($respDetalle["t8"]));
...
$objPHPExcel->getActiveSheet()->getColumnDimension('G')->setWidth(12.72);
$objPHPExcel->getActiveSheet()->getColumnDimension('H')->setWidth(12.72);
$objPHPExcel->getActiveSheet()->getColumnDimension('I')->setWidth(12.72);
$objPHPExcel->getActiveSheet()->getColumnDimension('J')->setWidth(12.72);
$objPHPExcel->getActiveSheet()->getColumnDimension('K')->setWidth(12.72);
$objPHPExcel->getActiveSheet()->getColumnDimension('L')->setWidth(12.72);
/* 
* CREAR EL ARCHIVO
*/
...
# Nombre del archivo
header('Content-Disposition: attachment; filename=" INGRESOS DE STOCK '.$documento.'- '.$fecha.'.xls"');
