...
# Titulo de la hoja
$objPHPExcel->getActiveSheet()->setTitle("DOCUMENTOS -".$fecha);
...
// TITULO
$fila = 2;
$objPHPExcel->getActiveSheet()->SetCellValue("D$fila", 'DOCUMENTOS');
...
$objPHPExcel->getActiveSheet()->SetCellValue("B$fila", 'COD. DOC');
...
$objPHPExcel->getActiveSheet()->SetCellValue("C$fila", 'TIPO DE DOCUMENTO');
...
$sqlDetalle = mysql_query("SELECT * FROM tipo_documentojf") or die(mysql_error());
...
while($respDetalle = mysql_fetch_array($sqlDetalle)){
    ...
    $objPHPExcel->getActiveSheet()->SetCellValue("B$fila", utf8_encode($respDetalle["cod_doc"])); 
...
$objPHPExcel->getActiveSheet()->getColumnDimension('B')->setWidth(10.72);
$objPHPExcel->getActiveSheet()->getColumnDimension('C')->setWidth(22.72);
/* 
* CREAR EL ARCHIVO
*/
...
# Nombre del archivo
header('Content-Disposition: attachment; filename=" DOCUMENTOS - '.$fecha.'.xls"');
