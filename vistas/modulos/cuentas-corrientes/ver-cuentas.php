                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group col-lg-2">
                            ...
                            <div class="input-group">
                                ...
                                <input type="date" class="form-control input-lg" name="cancelarFechaUltima" id="cancelarFechaUltima" min="<?php date_default_timezone_set("America/Lima");
                                                                                                                                            $fecha = new DateTime();
                                                                                                                                            echo $fecha->format("Y-m-01") ?>" required>
