    ...
    <div class="box">
      ...
      <div class="box-header with-border">
        ...
        <div class="pull-right">
          <button class="btn btn-outline-success btnReporteCuentasPendientes"  fechaInicial="" fechaFinal="" style="border:green 1px solid">
      ...
      <div class="box-body">
       ...
       <table class="table table-bordered table-striped dt-responsive tablaCuentasPendientes">
