    ...
    <section class="content">
        ...
        <div class="box">
            ...
            <div class="box-header with-border">
                ...
                <!-- <button class="btn btn-info btnIngresoDeta" data-toggle='modal' data-target='#modalVisualizarArreglos' codigoServicio>
                    <i class="fa fa-eye"></i> Ver arreglos
                </button> -->


                <a href="vistas/reportes_excel/rpt_enarreglos.php" class="btn btn-default" style="border:green 1px solid">
                    <img src="vistas/img/plantilla/excel.png" width="20px"> Reporte de Arreglos
                </a>
...
#region Ver arreglo
--------------------------------->
<div id="modalVisualizarArreglos" class="modal fade" role="dialog">
        ...
        <div class="modal-content">
            ...
            <form role="form" method="post">
                ...
                <div class="modal-header" style="background:#3c8dbc; color:white">
                    ...
                    <h4 class="modal-title">Detalle de los arreglos</h4>
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group col-lg-2">
                            ...
                            <div class="input-group">
                                ...
                                <strong><input type="text" class="form-control input-sm" name="arreglos" id="arreglos" required readonly></strong>
