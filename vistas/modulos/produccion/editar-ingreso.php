<div class="content-wrapper">
  ...
  <section class="content">
    <div class="box">
      ...
      <div class="box-body">
        <input type="hidden" value="<?=$_SESSION["perfil"];?>"
        id="perfilOculto"> 
        <input type="hidden" value="<?=$_GET["idIngreso"];?>"
        id="codigoIngreso">

        <table
          class="table table-bordered table-striped dt-responsive tablaEditarDetalleIngreso"
          width="100%"
        >
          <thead>
            <tr>
