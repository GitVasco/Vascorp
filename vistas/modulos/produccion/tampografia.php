<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Tampografia</li>
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <table class="table table-bordered table-striped dt-responsive tablaTampografia" width="100%">
            ...
            <div class="col-lg-6">
                <div class="box box-warning">
                    ...
                    <form role="form" method="post" class="formularioRegistrarTampografia">
                                ...
                                <div class="form-group col-lg-9">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control input-sm selectpicker" name="articulosCorte" id="articulosCorte" data-live-search="true" data-size="10" required>
                                            ...
                                            $estampado = ModeloCortes::mdlArticulosTampografia(null);
