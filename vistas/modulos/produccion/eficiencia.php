          ...
          <div class="box-body">
            ...
            <!-- ENTRADA PARA EL INICIO -->
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="date" class="form-control input-lg" name="inicio" placeholder="Fecha de inicio" required>
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="date" class="form-control input-lg" name="fin" placeholder="Fecha de fin" required>
