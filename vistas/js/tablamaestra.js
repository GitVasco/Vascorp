...
$(".TablaMaestraCabecera").DataTable({
    ajax:
        "ajax/maestros/tabla-maestracabecera.ajax.php?perfil=" +
        $("#perfilOculto").val(),
    deferRender: true,
    retrieve: true,
    processing: true,
...
$(".TablaMaestraCabecera tbody").on(
    "click",
    "button.btnActivarSubLinea",
    function () {
...
function cargarTablaMaestraDetalle(codigoSubLinea) {
    $(".TablaMaestraDetalle").DataTable({
        ajax:
            "ajax/maestros/tabla-maestradetalle.ajax.php?perfil=" +
            $("#perfilOculto").val() +
            "&codigoSubLinea=" +
            codigoSubLinea,
        deferRender: true,
...
$(".TablaMaestraCabecera").on("click", ".btnCrearSubLinea", function () {
    $("#nuevoVal3").val("");
    $("#nuevaDescCortaSelect").val("");
    $("#nuevaDescCortaSelect").selectpicker("refresh");
