...
class ModeloTalonarios
{
    ...
    static public function mdlMostrarTalonariosB($valor)
    {
        ...
        */
        if ($valor == "01") {
            ...
            $sql = "SELECT
                    ...
                    FROM
                        talonariosjf
                    WHERE LEFT(serie_factura,1) IN ('F','B')";
            ...
            $sql = "SELECT
                    ...
                    FROM
                        talonariosjf
                    WHERE LEFT(serie_boletas,1) IN ('F','B')";
